...
* 算法方面也只是问了下快排，还有非递归快排\贪心算法\弹性伸缩\架构的设计uml图

* 多线程的实现方式有哪些。

* 1.对框架了解吗？hibernate一级缓存和二级缓存的区别是？ 3.有哪些MySQL优化策略？说一下你在工作中怎么能够知道这些查询语句进行了全表扫描？ 4.设计模式了解多少？介绍几种自己熟悉的设计模式？单例模式怎么保证线程安全？

* 2.从逻辑和物理内存两个方面讲一下ArrayList和lLinkedlist区别。 3.讲一下你对jvm的理解，说说jdk jvm jre分别是什么，区别在哪里呢？ 4.期望工资待遇，城市（武汉？合肥？）最后没过，待遇要高了（其实是自己菜了

* 了接口和抽象类的区别 3.问了自己接触过哪些开源框架 4.让手写汉罗塔代码

* 1、起一个线程的方式，不要忘记Callable
...
![](/Users/chenyanan/Downloads/gitproject/java-interview/面试/jdbc.png)
