...
* ThreadLocal的内存泄漏问题
* CAS自旋锁、基础锁的概念
* spring的核心原理，数据库调优，redis，分布式锁等等。
* 算法方面也只是问了下贪心算法\弹性伸缩\架构的设计uml图
* 注册中心，链路追踪，服务降级，服务网管，负载均衡
* 多线程的实现方式有哪些。
* 1.对框架了解吗？hibernate一级缓存和二级缓存的区别是？ 2.JVM和GC了解多少？为什么要分年轻代和老年代？分别执行什么垃圾回收方法？ 3.有哪些MySQL优化策略？说一下你在工作中怎么能够知道这些查询语句进行了全表扫描？ 4.设计模式了解多少？介绍几种自己熟悉的设计模式？单例模式怎么保证线程安全？
