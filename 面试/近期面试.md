...
zoom、大智慧、蔚来、佰才邦、谊品生鲜

### 待补充知识点

todo：Springboot 中自定义注解实现操作员日志功能 
...
* ACK确认机制
  ...
  这个使用就要使用Message acknowledgment 机制，就是**消费端消费完成要通知服务端，服务端才把消息从内存删除。**
